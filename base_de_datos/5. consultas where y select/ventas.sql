...
select * from Productos where precio = '1300';
select * from Ventas where deleted = 'activo';
select * from Detalle_ventas where venta_id = '1';
select * from Ventas where fecha between '2025-05-19' and '2025-06-04';
select * from Productos where descripcion like 'U%';
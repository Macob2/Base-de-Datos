...
select * from usuarios where deleted = 'activo'; 
select * from tipo_usuarios where nombre_tipo = 'Administrador';
select * from usuarios where nombre_tipo like 'V%'; 
select * from usuarios where created_at between '2025-05-19' and '2025-06-03'; 